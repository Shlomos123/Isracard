  ...
  signInWithGoogleAsync = async () => {
    try {
      const result = await Expo.Google.logInAsync({
        behavior: 'web',
        androidClientId: '670206096375-iulai14b7a6mnj501u1ufi4hjq21c15a.apps.googleusercontent.com',
        iosClientId: '670206096375-jdu5csantr2vce1hmibo4ctp806ufscs.apps.googleusercontent.com',
  ...
  // }
    ...
    <Image
      ...
      />
            ...
            <Button full iconLeft style={[General.margin10,{backgroundColor: "red", padding: 10 }]}
      ...
      />
                <Text style={[General.text, { fontSize: 16, fontWeight: 'bold', color: "white"}]}>{'Or with google'}</Text>
            </Button>
            {/* <Button full iconLeft style={[General.margin10,{width: width*0.9, alignSelf: 'center'}]}
                onPress={() => this.props.navigation.navigate('MoviesList')}
                >
                <Text style={[General.text, { fontSize: 26, fontWeight: 'bold', color: "white", }]}>{' LOGIN'}</Text>
            </Button> */}
            </View>
            <Button full iconLeft style={[General.margin10,{width: width*0.9, alignSelf: 'center'}]}
                onPress={() => this.props.navigation.navigate('MoviesList')}
                >
                <Text style={[General.text, { fontSize: 16, fontWeight: 'bold', color: "white", }]}>{' Login'}</Text>
            </Button>
            </ScrollView>
        </Content>
